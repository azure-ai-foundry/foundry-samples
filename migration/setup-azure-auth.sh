...
echo -e "${NC}   ./run-migration-docker-auth.sh --help${NC}"
echo -e "${NC}   ./run-migration-docker-auth.sh --use-api --production-resource nextgen-eastus --production-subscription <subscription-id> --production-tenant <tenant-id> your-assistant-id${NC}"
echo -e "${NC}   ./run-migration-docker-auth.sh --project-connection-string \"your-connection-string\" --production-resource nextgen-eastus --production-subscription <subscription-id> --production-tenant <tenant-id> your-assistant-id${NC}"
echo ""