...
- [score-model-grader/sample_finetuning_rft.yaml](reinforcement/score-model-grader/sample_finetuning_rft.yaml) — Uses a score model grader (e.g., o3-mini) to evaluate outputs.
