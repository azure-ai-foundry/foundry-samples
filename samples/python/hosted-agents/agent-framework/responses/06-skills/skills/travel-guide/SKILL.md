...
4. After the script returns, tell the user the PDF path and provide the returned `sandbox_uri` as the download link when it is present. Briefly summarize the guide.
