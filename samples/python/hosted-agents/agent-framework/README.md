...
| 6 | [Skills](responses/06-skills/) | An agent using native Agent Framework file-based skills, demonstrating skill discovery and a script-backed PDF travel guide skill. |
