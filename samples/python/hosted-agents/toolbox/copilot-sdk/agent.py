"""CopilotToolboxAgent — Copilot SDK agent with Foundry toolbox MCP tools.

Bridges the Copilot SDK with Foundry toolbox by:
...
class CopilotToolboxAgent:
    ...
    Connects to the Foundry toolbox MCP endpoint via HTTP, discovers tools,
    ...
    async def start(self) -> None:
        ...
        if self._toolbox_endpoint:
            ...
            logger.info("No toolbox endpoint configured; using skills only")
